...
> An admin CLI window is required because interacting with the `minikube` command always needs elevated permissions.

### Change number of replicas

## References

* [ACR secrets](https://docs.microsoft.com/en-us/azure/container-registry/container-registry-auth-aks)
